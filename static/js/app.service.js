(function () {
   angular.module('avengers.service', [])
       .service('AvengersRepository', AvengersRepository);

    function AvengersRepository() {
        return {
            fetchAll: function() {
                return listOfAvengers;
            },
            fetchOne: function(index) {
                return listOfAvengers[index];
            }
        }
    }
